...
//自己加的
#define RESTORE_CACHE_ASM_LOCALITY 3
#define RESTORE_CACHE_MY_ASM 4
...
//自己加的
#define REWRITE_CAPPING_LOCALITY 4
#define REWRITE_CAPPING_MY 5
#define REWRITE_CAPPING_LBW 6
#define REWRITE_CAPPING_DOUBLESIZE 7
#define REWRITE_CAPPING_FCRC 8
