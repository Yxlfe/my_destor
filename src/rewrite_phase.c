...
SyncQueue* read_queue = NULL;
SyncQueue* chunk_queue = NULL;
SyncQueue* hash_queue = NULL;
SyncQueue* trace_queue = NULL;
SyncQueue* dedup_queue = NULL;
SyncQueue* rewrite_queue = NULL;
struct rewrite_buffer rewrite_buffer = {0};
struct rewrite_buffer_my rewrite_buffer_my = {0};
